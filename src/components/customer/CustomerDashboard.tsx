...
const CustomerDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-food-gray">
      <CustomerHeader onSearch={handleHeaderSearch} />
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {searchResults && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold">Search Results for "{searchResults}"</h2>
              <Button 
                variant="outline" 
        ...
        {/* Restaurants Section - Only show when not searching */}
        {!searchResults && (
